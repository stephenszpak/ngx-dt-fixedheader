...
export class DataTableBodyComponent implements OnInit, OnDestroy {
  ...
  @Input() fixedHeaderBodyHeight: number;
  ...
  private maxBodyHeight = (this.fixedHeader == true ? this.fixedHeaderBodyHeight + 'px' : '100%');
  ...
  set bodyHeight(val) {
    if (this.scrollbarV) {
      this._bodyHeight = val + 'px';
        ...
        this._bodyHeight = this.fixedHeaderBodyHeight + 'px';
        this.maxBodyHeight = this.fixedHeaderBodyHeight + 'px';
    }
    else {
  ...
  getRowsStyles(rows: any): any {
    ...
    if ((this.fixedHeader || this.scrollbarV) && this.virtualization) {
      let idx = 0;
  ...
  refreshRowHeightCache(): void {
    if ((!this.fixedHeader && !this.scrollbarV) || ((this.fixedHeader || this.scrollbarV) && !this.virtualization)) {
      return;
    }
